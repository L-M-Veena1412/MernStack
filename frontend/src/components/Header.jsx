  ...
  return (
    <header className={styles.header}>
      ...
      <nav className={styles.nav}>
        ...
        <NavLink to="/checkout" className={({ isActive }) => isActive ? styles.active : undefined}>
          Checkout
        </NavLink>

        {user && (
          <NavLink to="/my-orders" className={({ isActive }) => isActive ? styles.active : undefined}>
            My Orders
          </NavLink>
        )}

        {!user && (
          <NavLink to="/auth" className={({ isActive }) => isActive ? styles.active : undefined}>
            Sign In
          </NavLink>
        )}
